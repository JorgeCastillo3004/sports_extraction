...
def main():
	...
	if create_leagues_flag:
		create_leagues(["HOCKEY","BASKETBALL", "AM._FOOTBALL", "BASEBALL"]) #, "GOLF", "AM._FOOTBALL", "BASEBALL"

	if teams_creation_flag:
		teams_creation(["HOCKEY","BASKETBALL", "AM._FOOTBALL", "BASEBALL"]) # , "GOLF", "AM._FOOTBALL", "BASEBALL"

	if results_extraction_flag:
		results_fixtures_extraction(["HOCKEY","BASKETBALL", "AM._FOOTBALL", "BASEBALL"], name_section = 'results')
