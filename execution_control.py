...
while True:
	...
	if enable_execution_s1:		
		extract_news(driver, section_schedule['EXTRACT_NEWS']['SPORTS'], section_schedule['EXTRACT_NEWS']['MAX_OLDER_DATE_ALLOWED'])
	...
	if enable_execution_s3:
		create_leagues(driver, section_schedule['CREATE_TEAMS']['SPORTS'])
	...
	if enable_execution_s4:
		get_results(driver, section_schedule['GET_RESULTS']['SPORTS'], section = 'results')
	...
	if enable_execution_s5:
		get_results(driver, section_schedule['GET_FIXTURES']['SPORTS'], section = 'fixtures')
	...
	if enable_execution_s6:
		create_player(driver, section_schedule['GET_PLAYERS']['SPORTS'])
